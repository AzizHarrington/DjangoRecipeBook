...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dish.author'
        db.alter_column(u'dishes_dish', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Dish.author'
        db.alter_column(u'dishes_dish', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'dishes.dish': {
            'Meta': {'ordering': "('-likes',)", 'object_name': 'Dish'},
